 ...
 */
@Controller
@RequestMapping("${rootPath}/appendix")
public class AppendixController {

    private Logger logger = Logger.getLogger(AppendixController.class.getName());
     ...
     * @param response
     */
    @RequestMapping(value = "/getAppendix")
    public void getAppendix(AidedInfo aided, Integer currentPage, Integer pageSize, HttpServletRequest request, HttpServletResponse response) {
